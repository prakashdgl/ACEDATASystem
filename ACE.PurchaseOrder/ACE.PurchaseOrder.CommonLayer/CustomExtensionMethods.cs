...
namespace ACE.PurchaseOrder.CommonLayer
{
  public static class CustomExtensionMethods
  {
    ...
    public static string cxReplaceStringCharacter(this string pSourceString, string pNewValue, int pReplacePosition)
    {
      return CustomFunctions.ReplaceStringCharacter(pSourceString, pNewValue, pReplacePosition);
    }
  ...
  public abstract class CustomFunctions
  {
    ...
    public static string ReplaceStringCharacter(string pSourceString, string pNewValue, int pReplacePosition)
    {
