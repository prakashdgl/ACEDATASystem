...
namespace ACE.PurchaseOrder.DataLayer
{
  public class UsersDL : CommonForAllDL
  {
    ...
    public bool GetLogin()
    {
      ...
      {
        ErrorLog.LogErrorMessageToDB("UserDl.cs", "", "GetLogin", ex.Message, new ACEConnection());
        return false;
      }
    }
    ...
    public TransactionResult UpdateLastLoginDate(int userID)
    {
      ...
      {
        ErrorLog.LogErrorMessageToDB("UserDL.cs", "", "UpdateLastLoginDate", ex.Message, new ACEConnection());
        return new TransactionResult(TransactionStatus.Failure, "Failure Updating");
      }
    }
    ...
    internal TransactionResult AddEditUser(Database db, DbTransaction transaction)
    {
      ...
      {
        ErrorLog.LogErrorMessageToDB("UserDL.cs", "", "AddEditUser", ex.Message, new ACEConnection());
        return new TransactionResult(TransactionStatus.Failure, "Failure Updating");
      }
    }
    ...
    internal TransactionResult AddCompanyXUsers(Database db, DbTransaction transaction)
    {
      ...
      {
        ErrorLog.LogErrorMessageToDB("UserDL.cs", "", "AddCompanyXUsers", ex.Message, new ACEConnection());
        return new TransactionResult(TransactionStatus.Failure, "Failure Updating");
      }
    }
    ...
    private TransactionResult AddEditUsersXPages(Database db, DbTransaction transaction)
    {
      ...
      {
        ErrorLog.LogErrorMessageToDB("UserDL.cs", "", "AddEditUsersXPages", ex.Message, new ACEConnection());
        return new TransactionResult(TransactionStatus.Failure, "Failure Updating");
      }
    }
