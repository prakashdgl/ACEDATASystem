<%@ Page Title="" Language="C#" MasterPageFile="~/Order.Master" AutoEventWireup="true"
    CodeBehind="ManageCustomers.aspx.cs" Inherits="ACE.PurchaseOrder.ManageCustomers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageMainContent" runat="server">
                ...
                <div style="word-spacing: 2px; line-height: 1.5" align="justify">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        ...
                        <tr id="trGridRow" runat="server">
                            <td colspan="2" style="vertical-align: top; text-align: center;">
                                <asp:GridView ID="gvContactDetails" runat="server" DataKeyNames="ContactID" CellPadding="5"
                                    HeaderStyle-HorizontalAlign="Left" TabIndex="5" OnSelectedIndexChanged="gvContactDetails_SelectedIndexChanged"
                                    OnRowDeleting="gvContactDetails_RowDeleting" OnRowCreated="gvContactDetails_RowCreated" OnRowEditing="gvContactDetails_RowEditing"
                                    OnRowDataBound="gvContactDetails_RowDataBound" OnPageIndexChanging="gvContactDetails_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:ButtonField DataTextField="ContactName" HeaderText="Contact Name" CommandName="select"
                                            SortExpression="ContactName" ItemStyle-Width="33%">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                    <tr>
                                                        <td style="width: 100%" align="left">
                                                             <asp:ImageButton ID="ibtnEditContact" runat="server" ToolTip="Edit" ImageUrl="~/Images/detailButton.gif"
                                                                                            AlternateText="Edit" CommandName="Edit"></asp:ImageButton>
                                                            
                                                        </td>
                                                        <%--<td style="width: 50%" align="right">
                                                            <asp:ImageButton ID="ibtnDeleteContact" runat="server" ToolTip="Delete" ImageUrl="~/Images/icon_del.gif"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                    <tr>
                                                        <td style="width: 100%" align="left">
                                                            ...
                                                            <%--<asp:ImageButton ID="ibtnEditContact" runat="server" ToolTip="Edit" ImageUrl="~/Images/icon_edit.gif"
                                                                AlternateText="Edit" CommandName="Edit"></asp:ImageButton>--%>
                                                        </td>
                                                        <%--<td style="width: 50%" align="right">
                                                            <asp:ImageButton ID="ibtnDeleteContact" runat="server" ToolTip="Delete" ImageUrl="~/Images/icon_del.gif"
                        ...
                        <tr id="trContactDetailView" runat="server">
                                ...
                                <table border="0" cellpadding="3" cellspacing="1" width="100%">
                                    <tr>
                                        ...
                                        <td style="width: 80%" align="left">
                                            <asp:Label ID="lblLastNameValue" runat="server" Text="Last Name Description" CssClass="TextResults"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:Label ID="lblFirstNameValue" runat="server" Text="First Name Value" CssClass="TextResults"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="Label">
                                            <asp:Label ID="lblSpouseName" runat="server" Text="Spouse Name" CssClass="Label"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:Label ID="lblSpouseNameValue" runat="server" Text="Spouse Name Value" CssClass="TextResults"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="Label">
                                    ...
                                    <tr>
                                        <td align="right" class="Label">
                                            <asp:Label ID="lblContactID" runat="server" Text="Contact ID" Visible="false" CssClass="Label"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:Label ID="lblContactIDValue" runat="server" Text="ContactID" Visible="false"
                        ...
                        <tr id="trContactDetailTabs" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Initialize() {
            $('#<%=gvContactDetails.ClientID%>').tablePagination();
            //Quick search 

            $('#<%=txtSearchID.ClientID%>').keyup(function (event) {
                var searchKey = $(this).val().toLowerCase();
                if (searchKey.length > 0) {
                    $("#<%=gvContactDetails.ClientID%> tr.row").each(function () {
                    ...
                    if ($("#<%=gvContactDetails.ClientID%> tbody:first tr:visible").length == 1) {
                        $("#<%=gvContactDetails.ClientID%> tbody:first").append('<tr id="NoRecords" rowspan="3" valign="middle" class="tdLabelCenter"><td colspan="10" class="tdNoRecords"><h3> No matching records found </h3></td></tr>');
                    }
                }
